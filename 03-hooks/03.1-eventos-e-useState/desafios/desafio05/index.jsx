...
Descrição:
Neste desafio você recebe um formulário multi-etapas para obter dados do usuário. Com o JSX já no lugar, 
atualize o estado do componente e funções para permitir que o usuário progrida através do formulário, atualizando o estado conforme necessário.

Tarefas:
- [x] Permitir ao usuário transicionar para a próxima etapa
- [x] Permitir ao usuário retornar para a etapa anterior
- [x] Atualizar formData conforme o usuário progride através do formulário 
